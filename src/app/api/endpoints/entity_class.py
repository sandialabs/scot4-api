...
from .generic import generic_post, generic_put, generic_get, generic_delete, generic_history, generic_search, generic_export
...
generic_delete(router, crud.entity_class, TargetTypeEnum.entity_class, schemas.EntityClass)
