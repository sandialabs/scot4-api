...
generic_post(router, crud.incident, TargetTypeEnum.incident, schemas.Incident, schemas.IncidentCreate)
generic_put(router, crud.incident, TargetTypeEnum.incident, schemas.Incident, schemas.IncidentUpdate)
...
generic_source_add_remove(router, crud.incident, TargetTypeEnum.incident, schemas.Incident)
...
generic_upvote_and_downvote(router, crud.incident, TargetTypeEnum.incident, schemas.Incident)
generic_user_links(router, crud.incident, TargetTypeEnum.incident, schemas.Incident)
