...
generic_post(
    router, crud.vuln_track, TargetTypeEnum.vuln_track, schemas.VulnTrack, schemas.VulnTrackCreate
)
generic_put(
    router, crud.vuln_track, TargetTypeEnum.vuln_track, schemas.VulnTrack, schemas.VulnTrackUpdate
)
