...
from app.models.mixins import TimestampMixin, TagMixin, SourceMixin, EntryMixin, PromotionToMixin
from app.enums import StatusEnum, TlpEnum


class Dispatch(Base, TimestampMixin, TagMixin, SourceMixin, EntryMixin, PromotionToMixin):
