...
def test_create_in_object_feed(db: Session, faker: Faker) -> None:
    ...
    link, count = crud.link.query_with_filters(db, filter_dict={"v0_id": alert_group.id, "v0_type": TargetTypeEnum.alertgroup, "v1_id": db_obj.id, "v1_type": TargetTypeEnum.feed})
